      ...
      {isLoadingFetchBlog ? (
        ...
        <>
          ...
          <div className="w-full sm:h-[18rem] p-2">
            <img src={baseUrl+blogData?.cover_image} alt="coverimage" className=" w-full h-[10rem] sm:h-full rounded-md object-cover" />
          </div>

          <div className="flex justify-center p-2 items-center">
            {/** Author info & date */}
            <div className="flex justify-center items-center pl-2">
              <img src={baseUrl+blogData?.["author_profile_image"]} alt="author-profileimage" className="w-7 h-7 sm:w-10 sm:h-10 rounded-full" />
